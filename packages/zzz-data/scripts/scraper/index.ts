...
import { ATTACK_TYPES, ATTRIBUTES, SPECIALTIES } from "@/constants"
...
const commonDataPath = resolve(_dirname, "../../data-hakush/common.json")
const agentsDataPath = resolve(_dirname, "../../data-hakush/agents.json")
const bangboosDataPath = resolve(_dirname, "../../data-hakush/bangboos.json")
const wEnginesDataPath = resolve(_dirname, "../../data-hakush/w-engines.json")
